...
[hola]({% link _collection/acrosport_home.md %})

[![An old rock in the desert](/images/0-test-pagina-principal.png "Atletismo TEST")]({% link _collection/acrosport_home.markdown %})
